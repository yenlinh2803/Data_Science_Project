...
BEGIN
    -- CONTROL VARIABLE:
	v_source_object_code := 'QXMUS02';
    v_flow_lb := 'usp_update_dim_usr01_user_qxm_quoinex_is_system_user';
	...
	LOOP
        ...
        LIMIT 1;
            ...
            -- EDW LOAD FUNCTION:
            CALL etlws.usp_update_dim_usr01_user_qxm_quoinex_is_system_user(v_batch_id);
           COMMIT;

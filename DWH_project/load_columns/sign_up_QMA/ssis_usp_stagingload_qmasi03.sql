 ...
 * 
  INSERT INTO etlctrl.staging_config_t(	
	...
	VALUES(
		'usp_stagingload_qmasi03', 5, 1, false, 
...
BEGIN		
	v_source_object_cd := 'usp_stagingload_qmasi03';
	...
	IF v_params IS NULL 
		...
		ELSE
			...
			COMMIT;
			CALL staging.usp_stagingload_qmasi03(v_is_overlap_load, v_overlap_interval, v_overlap_from_bor);
	END IF;
END
$$

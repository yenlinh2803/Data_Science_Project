...
-- SET ROLE data_team;
-- DROP TABLE staging.qmasi03_liq_mobile_android_sign_up_t;
CREATE TABLE staging.qmasi03_liq_mobile_android_sign_up_t(
-- Control
	rid 				serial NOT NULL,
...
--DROP TABLE staging.qmasi03_liq_mobile_android_sign_up_00_p
CREATE TABLE staging.qmasi03_liq_mobile_android_sign_up_00_p PARTITION OF staging.qmasi03_liq_mobile_android_sign_up_t
    FOR VALUES IN(0,2)
   	TABLESPACE ts_hotstore02;
   
--DROP TABLE staging.qmasi03_liq_mobile_android_sign_up_01_p
CREATE TABLE staging.qmasi03_liq_mobile_android_sign_up_01_p PARTITION OF staging.qmasi03_liq_mobile_android_sign_up_t
    FOR VALUES IN(1,3)
...
CREATE INDEX qmasi03_00_p_ctrl_batch_id_idx ON staging.qmasi03_liq_mobile_android_sign_up_00_p (ctrl_batch_id,batch_partition_key) TABLESPACE ts_hotstore01;
CREATE INDEX qmasi03_01_p_ctrl_batch_id_idx ON staging.qmasi03_liq_mobile_android_sign_up_01_p (ctrl_batch_id,batch_partition_key) TABLESPACE ts_hotstore02;


CREATE INDEX qmasi03_00_p_id_idx ON staging.qmasi03_liq_mobile_android_sign_up_00_p (id) TABLESPACE ts_hotstore01;
CREATE INDEX qmasi03_01_p_id_idx ON staging.qmasi03_liq_mobile_android_sign_up_01_p (id) TABLESPACE ts_hotstore02;

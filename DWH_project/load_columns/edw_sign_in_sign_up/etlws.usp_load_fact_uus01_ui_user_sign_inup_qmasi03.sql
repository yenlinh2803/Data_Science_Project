...
CREATE OR REPLACE PROCEDURE etlws.usp_load_fact_uus01_ui_user_sign_inup_qmasi03(p_batch_id integer)
 LANGUAGE plpgsql
AS $procedure$ 
DECLARE
	-- CONST
	c_DES_OBJCODE varchar(10):=upper('uus01');
	c_SRC_OBJCODE varchar(10):= upper('qmasi03');
	c_FLOW varchar(150):='usp_load_fact_uus01_ui_user_sign_inup_qmasi03';
	-- BATCH
	v_flow_load_id int4;
	v_loadType_id int2;
	v_partitionKey int2;
...
--	FROM staging.qmasi03_liq_mobile_android_sign_up_t stg

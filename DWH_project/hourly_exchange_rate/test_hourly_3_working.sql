...
-- 1 month-1currency: 4m
		...
		BEGIN
				...
				select array(SELECT distinct id FROM edw_dim.cur01_currency_t limit 5) into v_currency_array;
				...
				if v_max_fx_hourly is null then 
					v_max_fx_hourly:= '2018-01-01 00:00:00'::timestamp;
				end if;
